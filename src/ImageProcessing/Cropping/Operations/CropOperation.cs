...
public sealed class CropOperation : Crop
{
    ...
    {
        AddOperation<ReadOnlyPackedPixelBuffer<Mono>, PackedPixelBuffer<Mono>>(CropMono);
        AddOperation<ReadOnlyPackedPixelBuffer<Mono8>, PackedPixelBuffer<Mono8>>(CropMono8);
        AddOperation<ReadOnlyPackedPixelBuffer<Mono16>, PackedPixelBuffer<Mono16>>(CropMono16);

        AddOperation<ReadOnlyPackedPixelBuffer<Rgb>, PackedPixelBuffer<Rgb>>(CropRgb);
        AddOperation<ReadOnlyPackedPixelBuffer<Rgb24>, PackedPixelBuffer<Rgb24>>(CropRgb24);
        AddOperation<ReadOnlyPackedPixelBuffer<Rgb48>, PackedPixelBuffer<Rgb48>>(CropRgb48);

        AddOperation<ReadOnlyPlanarPixelBuffer<RgbFFF>, PlanarPixelBuffer<RgbFFF>>(CropRgbFFF);
        AddOperation<ReadOnlyPlanarPixelBuffer<Rgb888>, PlanarPixelBuffer<Rgb888>>(CropRgb888);
        AddOperation<ReadOnlyPlanarPixelBuffer<Rgb161616>, PlanarPixelBuffer<Rgb161616>>(CropRgb161616);
    }
